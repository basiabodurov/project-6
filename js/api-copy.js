(function () {
   ...
   angular.module('quotesondev',[])
     ...
     .factory('templateSrc', function(){
                 var template_src_url = '/quotes-on-dev/wp-content/themes/quotesondev/build/js/angular/templates/'
                 ...
                 return {
                    getRandomQuote: function(){
                        ...
                        function quote(response) {
                            ...
                            return{
                                title: quote.title.rendere,
                                source: quote._qod_quote_source_url,
                                slug: quote.slug,
     ...
     .controller('quoteFormCtrl', ['$scope', 'quotes', function($scope, quotes){
         ...
         function quoteSubmitSuccess(response) {
            ngular.element('#quote-submission-form').slideUp();
         ...
         $scope.submitQuote = function(quoteForm){
            ...
            if(quoteForm.$valid) {
                // send it
                quotes.submit($scope.quote).then(function(quoteSubmitSuccess, quoteSubmitFail);
